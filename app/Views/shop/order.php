                ...
                <?php foreach ($getInfo as $row) : ?>
                    <div class="col-lg-4">
                        ...
                        <div class="address-info pb-8 mb-6">
                            <p class="address-detail pb-2">
                                <?php echo $row['billingFirst'];
                                echo '&nbsp' . $row['billingLast']; ?><br>
                    ...
                    <?php foreach ($getInfo as $row) : ?>
                        <div class="col-lg-4">
                            ...
                            <div class="address-info pb-8 mb-6">
                                <p class="address-detail pb-2">
                                    <?php echo $row['shippingFirst'];
                                    echo '&nbsp' . $row['shippingLast']; ?><br>
