                        ...
                        <div class="row cols-sm-2 cols-lg-4">
                            <div class="store">
                                <figure class="banner-radius">
                                    <img src="/theme/images/subpages/store-1.jpg" alt="store" width="280" height="280">
                            ...
                            <div class="store">
                                <figure class="banner-radius">
                                    <img src="/theme/images/subpages/store-2.jpg" alt="store" width="280" height="280">
                            ...
                            <div class="store">
                                <figure class="banner-radius">
                                    <img src="/theme/images/subpages/store-3.jpg" alt="store" width="280" height="280">
                            ...
                            <div class="store">
                                <figure class="banner-radius">
                                    <img src="/theme/images/subpages/store-4.jpg" alt="store" width="280" height="280">
